package com.jonathan.java.demo.comments;
...
public class CommentController {
	...
	public List<Comment> getLast(@PathVariable int limit) {
		return commentRepository.findLastComments(limit);
	}

	@GetMapping(path = "/{articleId}")
	public List<Comment> getAll(@PathVariable Long articleId) {
		return commentRepository.findAllCommentByArticle(articleId);
	}
	...
	public List<Comment> alreadyExists(@RequestParam("uid") String uid, @RequestParam("art") Long art,
		...
		return commentRepository.findCommentsByAuthorArticleAndContent(uid, art, txt);
	}
